...
const Header = () => {
    return (
      <nav className="flex justify-between items-center bg-neutral text-[#868686] p-4">
        <div className="text-white font-bold text-3xl racking-tight p-4 drop-shadow-[0_0_19px_var(--color-primary)]">
          MI_PORTAFOLIO
        </div>
        ...
        <button className="bg-[#0f3f42] text-[#03c6d2] px-6 py-4 rounded-sm border-2 border-[#0b6b72] font-bold hover:bg-primary hover:text-black transition-all text-xs">
          <a href="/hoja_de_vida.pdf" download="CV_Padilla_Dev.pdf">
            RESUME_PDF
          </a>
        </button>
      </nav>
